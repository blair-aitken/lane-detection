...
def main():
    ...
    if not images:
        print()
        print("No chessboard images found in: {args.img_dir}")
        print()
        print("What to do:")
        print("  1. Print chessboard_A4.png")
        print("  2. Take 10–15 photos with the SAME camera you’ll use for driving")
        print("  3. Save them into: data/chessboard_images")
        print()
